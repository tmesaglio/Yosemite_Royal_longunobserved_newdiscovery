...
ggsave("output/Fig1_records_per_year.pdf",width=8,height=5)
ggsave("output/Fig1_records_per_year.svg",width=8,height=5)
ggsave("output/Fig1_records_per_year.png",width=8,height=5)
